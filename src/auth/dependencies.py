...
require_document_create = require_permission(Permission.DOCUMENT_CREATE)
require_document_update = require_permission(Permission.DOCUMENT_UPDATE)
require_document_delete = require_permission(Permission.DOCUMENT_DELETE)
require_document_share = require_permission(Permission.DOCUMENT_SHARE)
